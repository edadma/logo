...
lazy val builtin: Map[String, Procedure] =
  List[Procedure](
    ...
    BuiltinFunction1("asinh", QuaternionDAL.asinhFunction),
    BuiltinFunction1("acosh", QuaternionDAL.acoshFunction),
    BuiltinFunction1("atanh", QuaternionDAL.atanhFunction),
