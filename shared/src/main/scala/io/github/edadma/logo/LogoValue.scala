...
case object LogoUnit               extends LogoValue { override val toString: String = ""                            }
...
case class PendingFor(varName: String, start: Double, end: Double, step: Double, body: Seq[LogoValue]) extends LogoValue:
